...
public Collection<? extends GrantedAuthority> getAuthorities (){
 List<GrantedAuthority> authorities = new ArrayList <>();
  ...
  this.persona.getRoleList().forEach(r -> {
       GrantedAuthority authority = new SimpleGrantedAuthority("ROLE_"+ r); /*el role es de fijo para que funcione*/
       authorities.add(authority);
   });
   return authorities;
}
    ...
    public boolean isEnabled() {
        return this.persona.getActive()==1; /*esta linea siver para ver si esta activo*/
    }
}